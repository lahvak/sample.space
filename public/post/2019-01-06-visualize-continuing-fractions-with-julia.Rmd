...
not even have any support for complex numbers, and all calculations has to be done
...
wrote some Python scripts that produced some pretty nice results, but were
...
find it. I believe now that I had it stored on `juliabox.org`, and when they
...
flexible, but at this moment I just want to see some pictures, so I cannot be
bothered to do this right).
...
One big problem with these images is that they are _not_ images of continuing
...
calculating convergents is of limited use: the numerator and denominator
